...
\begin{table}[!ht]
  ...
  \begin{tabular}{|l|l|l|}
  \hline
      \textbf{} & SLOC Live Probe Server & SLOC KAA \\ \hline
      \textbf{Java JDI} & 592 (Java) & 15 (Java) \\ \hline
      \textbf{DAP Base} & 267 (Python) & ~ \\ \hline
      \textbf{DAP Java} & 352 (Python) & 91 (Java) \\ \hline
      \textbf{DAP Python} & 142 (Python) & 26(Python) \\ \hline
      \textbf{DAP Javascript} & 257 (Python) & 24(Javascript) \\ \hline
      \textbf{DAP C} & 188 (Python) & 14(C) \\ \hline
  \end{tabular}
  \caption{SLOC of the Live Probe Server and Keep Alive Agent (To update after new Java changes)}
  \label{tab:sloc}
\end{table}
