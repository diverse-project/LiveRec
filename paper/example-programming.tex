...
\draw [line width=1.5]    (284.4,56.1) -- (337.6,56.47) ;
...
% Text Node
\draw (15.2,17) node [anchor=north west][inner sep=0.75pt]   [align=left] {line : 2};
% Text Node
\draw (22.4,39) node [anchor=north west][inner sep=0.75pt]   [align=left] {n : 3};
% Text Node
\draw (88,17) node [anchor=north west][inner sep=0.75pt]   [align=left] {line : 3};
% Text Node
...
% Text Node
\draw (159.8,17) node [anchor=north west][inner sep=0.75pt]   [align=left] {line : 4};
% Text Node
...
% Text Node
\draw (230,17) node [anchor=north west][inner sep=0.75pt]   [align=left] {line : 3};
% Text Node
...
% Text Node
\draw (347.2,17) node [anchor=north west][inner sep=0.75pt]   [align=left] {line : 6};
% Text Node
...
%In the 3 languages, we have implemented time measurement for the binary_search method (see appendix) with the array \[1,2,3,4,5,6\] looking for 9.
%The execution was repeated 100 times for each language.
