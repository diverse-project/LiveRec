...
def test_python_bubblesort():
    ...
    agent.start_server()
    agent.initialize()
    agent.load_code("/home/jbdod/CWI/LiveProbes/LiveFromDAP/src/livefromdap/target/python/bubblesort.py")
...
def test_python_prime():
    ...
    agent.start_server()
    agent.initialize()
    agent.load_code("/home/jbdod/CWI/LiveProbes/LiveFromDAP/src/livefromdap/target/python/prime.py")
